    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-16">
      ...
      {activeTab === 'personal' && (
        <div className="space-y-6 animate-in fade-in-50 duration-200">
          ...
          {/* Card 1.2: Đổi mật khẩu tài khoản / Thông tin bảo mật */}
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-6">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    {isGoogleAccount
                      ? 'Tài khoản được liên kết và xác thực an toàn thông qua Google OAuth.'
            ...
            {isGoogleAccount ? (
              <div className="p-5 rounded-xl bg-slate-950/60 border border-slate-800 space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl bg-slate-900 border border-slate-700 flex items-center justify-center shrink-0 shadow-sm">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2.5 py-0.5 text-[11px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full">
                        Đã liên kết Google
                      </span>
                    </div>
                    <p className="text-xs text-slate-400 leading-relaxed">
                      Tài khoản của bạn được bảo vệ trực tiếp bởi hệ thống bảo mật của Google. Bạn không cần đổi hoặc khởi tạo mật khẩu riêng trên cổng quản trị QuickBite.
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-3 flex flex-wrap items-center justify-between gap-3 border-t border-slate-800/80">
                  <span className="text-xs text-slate-500">
                    Để quản lý mật khẩu hoặc thiết lập xác thực 2 bước cho tài khoản:
                  </span>
                  <a
                    href="https://myaccount.google.com/security"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold rounded-xl border border-slate-700 transition-colors shadow-sm"
                  >
