...
[DependsOn(
    ...
    typeof(IdentityApplicationTestModule),
    typeof(IdentityEntityFrameworkCoreTestModule)
)]
public class IdentityWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(IdentityWebModule).Assembly));
        });
